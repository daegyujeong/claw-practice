/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 75b76408d86532f4bcc97f7bdd73cbdd)
// Runtime types generated with workerd@1.20260828.1 2026-08-25 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	GuessGameAgent: DurableObjectNamespace<import("./worker/index").GuessGameAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "GuessGameAgent";
	}
